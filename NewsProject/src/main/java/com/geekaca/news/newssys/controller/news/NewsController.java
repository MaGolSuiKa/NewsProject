...
import com.geekaca.news.newssys.config.MyLog;
...
//        PageResult newsPageResult = newsService.getNewsForIndexPage(pageNum);
//        if (newsPageResult == null) {
//            return "error/error_404";
//        }
//
//        request.setAttribute("blogPageResult", newsPageResult);
...
//    public String detail(HttpServletRequest request, @PathVariable("newsId") Long blogId, @RequestParam(value = "commentPage", required = false, defaultValue = "1") Integer commentPage) {
//        BlogDetailVO blogDetailVO = newsService.getBlogDetail(blogId);
//        if (blogDetailVO != null) {
//            System.out.println(blogDetailVO.getNewsContent());
...
//        PageResult blogPageResult = newsService.getBlogsPageByCategory(categoryName, page);
//        request.setAttribute("blogPageResult", blogPageResult);
...
//        PageResult newsPageResult = newsService.getBlogsPageBySearch(keyword, page);
//        request.setAttribute("blogPageResult", newsPageResult);
